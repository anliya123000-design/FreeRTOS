...
void led_task(void *pvParameter)
{
    ...
    if (led_gpio == LED_RED)   blink_time = 5000;
    if (led_gpio == LED_BLUE)  blink_time = 4000;
    if (led_gpio == LED_GREEN) blink_time = 3000;
    if (led_gpio == LED_YELLOW) blink_time = 2000; 
    if (led_gpio == LED_WHITE) blink_time =  1000;
